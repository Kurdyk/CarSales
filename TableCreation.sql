...
(
    MainBranch  int not null,
    OwnedBranch int not null,
    constraint MainConstrain
        foreign key (MainBranch) references Company (id),
    constraint OwnedConstrain
        foreign key (OwnedBranch) references Company (id)
);
